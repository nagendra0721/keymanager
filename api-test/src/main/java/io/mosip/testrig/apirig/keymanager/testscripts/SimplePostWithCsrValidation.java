...
public class SimplePostWithCsrValidation extends KeyManagerUtil implements ITest {

	private static final Logger logger = Logger.getLogger(SimplePostWithCsrValidation.class);
	...
	public void test(TestCaseDTO testCaseDTO)
		...
		String augmentedResponse = augmentResponseWithCsrProperties(response.asString());
